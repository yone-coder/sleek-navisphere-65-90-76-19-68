...
import { GamesCategoryTabs } from "@/components/games/GamesCategoryTabs";
import { EventsSection } from "@/components/games/sections/EventsSection";
import { GameSection } from "@/components/games/sections/GameSection";
...
import type { Game, GameEvent } from "@/components/games/types/pages";
        ...
        <Route path="/" element={
          <>
            ...
            <div className="pt-4 pb-24">
              <EventsSection gameEvents={gameEvents} />
              <GameSection title="Popular Sports Games" games={games.filter(g => g.category.includes("Sports"))} />
              <GameSection title="Trending Board Games" games={games.filter(g => g.category.includes("Board"))} />
              <GameSection title="Popular Games" games={popularGames} />
              <GameSection title="Suggested For You" games={games} />
            </div>
          </>
        } />
