    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="pt-[120px] px-4 max-w-7xl mx-auto">
        <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="games" className="space-y-8 mt-0">
          ...
          <TabsContent value="apps" className="space-y-8 mt-0">
            ...
            <div className="grid grid-cols-1 gap-8">
              <TopCharts type="app" limit={15} />
            </div>
          </TabsContent>
          
          <TabsContent value="arcade" className="space-y-8 mt-0">
            <div className="bg-white rounded-xl p-4 shadow-sm mb-6">
