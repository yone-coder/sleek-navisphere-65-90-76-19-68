    ...
    <div className="min-h-screen animate-fade-in">
      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        <div className="relative">
          {/* Main Header */}
          <div className={cn(
            "h-16 bg-white/80 backdrop-blur-xl border-b border-gray-100 transition-all duration-300",
            showSearch && "opacity-0 pointer-events-none"
          )}>
            <div className="h-full px-4 flex items-center gap-3 max-w-2xl mx-auto">
              <Button 
                variant="ghost" 
                size="icon"
              ...
              >
                <div className="relative cursor-pointer">
                  ...
                  <div className="w-full h-9 pl-10 pr-3 flex items-center bg-gray-50 rounded-full border border-gray-100">
              ...
              <Sheet>
                <SheetTrigger asChild>
                  ...
                  >
                    ...
                    <Badge 
                      className="absolute -top-0.5 -right-0.5 h-4 min-w-4 p-0.5 flex items-center justify-center bg-blue-500"
                    >
                      2
                    </Badge>
                  </Button>
          ...
          {/* Search Overlay */}
          <div className={cn(
            "absolute inset-0 bg-white h-16 transition-all duration-300",
            !showSearch && "opacity-0 pointer-events-none"
          )}>
            <div className="h-full px-4 flex items-center gap-3 max-w-2xl mx-auto">
