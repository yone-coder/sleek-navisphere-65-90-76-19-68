...
import { TournamentHero } from "@/components/tournament/sections/TournamentHero";
import { TournamentParticipantStats } from "@/components/tournament/sections/TournamentParticipantStats";
import { TournamentActions } from "@/components/tournament/sections/TournamentActions";
    ...
    <div className="relative group cursor-pointer" onClick={onImageClick}>
      ...
      <div className="absolute bottom-2 left-2 flex items-center space-x-1">
        ...
        <div className="bg-black/50 px-2 py-0.5 rounded backdrop-blur-sm">
          <span className="text-white text-xs font-medium">{game}</span>
        </div>
      </div>
    </div>
  );
