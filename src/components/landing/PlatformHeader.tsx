...
export function PlatformHeader() {
  return (
    <div className="w-full py-0 px-0">
      <div className="relative overflow-hidden p-4 md:p-6 transition-all duration-500">
        ...
        <div className="mb-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight mb-2 text-center">
          ...
          <div className="relative h-1.5 w-48 mt-4 mb-6 overflow-hidden rounded-full mx-auto">
