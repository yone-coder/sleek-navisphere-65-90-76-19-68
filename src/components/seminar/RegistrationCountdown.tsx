          ...
          <div className="mt-4">
            <div className="flex justify-between items-center">
              <div className={`px-2 py-0.5 rounded-md ${theme.accent} flex items-center`}>
                ...
                <span className={`font-semibold ${theme.text}`}>Apr 10</span>
                <span className="text-xs text-gray-500 ml-1">2025</span>
              </div>
              <div className={`px-2 py-0.5 rounded-md ${theme.accent} ${theme.text} font-bold flex items-center`}>
                <span>07:59</span>
                <span className="text-xs ml-0.5">PM</span>
              </div>
            </div>
          </div>
        </div>
